...
| When it triggers (incl. each resume session) | ≈11.1k cl100k tokens raw, ≈12.5–12.7k as read with Read-tool line prefixes — measured 2026-08-22 after the close-marker/totals-block documentation pass (was ≈10.7k/≈12.1–12.2k). Covers SKILL.md, the three Source-A reference files, and the calibration-summary allowance; add ~1.5–2k for the first artifact/state writes |
