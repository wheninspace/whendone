...
3. **Task table:** one row per subtask: status icon (✅/🔄/⬜), name, category, estimate, actual,
   ...
   `"—"` for an unfinished one; wrong: `"done"` (the icon already shows status).
...
<style>
  :root { --bg:#fff; --fg:#1a1a1a; --dim:#666; --card:#f5f5f5;
          --running:#1e6fd9; --paused:#a66800; --done:#1e8a3c; }
  @media (prefers-color-scheme: dark) {
    :root { --bg:#1a1a1a; --fg:#eee; --dim:#999; --card:#2a2a2a; } }
  :root[data-theme="dark"] { --bg:#1a1a1a; --fg:#eee; --dim:#999; --card:#2a2a2a; }
  :root[data-theme="light"] { --bg:#fff; --fg:#1a1a1a; --dim:#666; --card:#f5f5f5; }
  ...
  th:nth-child(4),td:nth-child(4),th:nth-child(5),td:nth-child(5) { white-space:nowrap; width:1%; }
...
<table>
  ...
  <tr><td>✅</td><td>Failing test read_skill</td><td class="dim">testing</td><td>8 m</td><td>11 m (+38 %)</td></tr>
