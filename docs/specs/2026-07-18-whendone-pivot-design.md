...
**Supersedes:** the direction portions of the 2026-07-17 pivot handoff
(`docs/plans/archive/2026-07-17-whendone-pivot-and-round3-handoff.md`, internal planning doc,
not shipped in this repo); partially supersedes the round-3 fixes plan
(`docs/plans/archive/2026-07-17-round3-fixes.md`, internal planning doc, not shipped in this
repo) (see §8)
...
- **`docs/plans/archive/2026-07-17-round3-fixes.md`** (internal planning doc, not shipped in
  this repo)**:** its Tasks 1–3, 8, 9, 11 map to stage 1 (and parts of 3); Tasks 4, 6, 7, 12 are absorbed into stages 2–5 in redesigned form; Task 5 is dropped. Once the stage-1 plan is written, propose moving the old plan to `docs/plans/archive/` (never delete unasked).
